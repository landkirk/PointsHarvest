...
- **Claiming points** — at the end of the run, claims any pending points from the rewards page so they don't sit unclaimed
...
Points Harvest does **not** require your Microsoft password or any credentials. It runs entirely within your browser session using your already-logged-in account.

## Installation

### 1. Download the latest release

Grab the `.zip` file from the [download button](https://pointsharvest.com) on the homepage. Unzip it to a permanent folder on your computer — don't delete this folder after installing.
...
Toggle **Developer mode** on using the switch in the top-right corner of the Extensions page. This allows loading unpacked extensions.
...
That's it — you're set up. Enjoy your points on autopilot. If you run into any issues, check the [FAQ](https://pointsharvest.com/#faq) on the homepage.
